...
public class SaveLoadSystemOld : MonoBehaviour
{
	...
	void Update () {
        ...
        /*if (keys != null)
        {
            Debug.Log("Can access keys");
            foreach (GameObject key in keys)
            {
                
                Debug.Log("Accessed keys");
                if (key != null)
                {
                    Debug.Log("Accessed keyscript");
                    characterData.haveKey[arrayLength] = key.GetComponent<KeyScript>().haveKey;
                }
            }
        }
        */
    ...
    public void SaveData()
    {
        ...
        /*if (keys != null)
        {
            foreach (GameObject key in keys)
            {
                ...
                if (key != null && characterData.haveKey != null)
                {
        ...
        if (keys != null)
        {
            foreach (GameObject key in keys)
            {
                ...
                if (key != null)
                {
                    ...
                    key.GetComponent<KeyScript>().haveKey = Convert.ToBoolean(PlayerPrefs.GetInt("keys", Convert.ToInt16(characterData.haveKey[arrayLength])));
                }
            }
        }
        */
